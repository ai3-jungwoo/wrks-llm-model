  ...
  return (
    <Link href={`/models/${model.id}`}>
      <motion.article
        ...
        whileHover={{ y: -4 }}
        whileTap={{ scale: 0.98 }}
        className="group relative bg-white rounded-2xl border border-gray-200 p-5 md:p-6 shadow-sm hover:shadow-lg transition-shadow duration-300 cursor-pointer h-full"
      >
        {/* Accent line */}
        <div
