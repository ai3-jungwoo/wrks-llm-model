...
export const providerColors: Record<string, string> = {
  "웍스 대표 모델": "#5D5FEF",
  All: "#6B7280",
  OpenAI: "#000000",       // OpenAI 블랙
  Google: "#4285F4",       // Google 블루
  Anthropic: "#D4A27F",    // Anthropic 베이지/브라운
  Perplexity: "#20808D",   // Perplexity 청록
  xAI: "#000000",          // xAI 블랙
  Upstage: "#5046E5",      // Upstage 퍼플
  LG: "#A50034",           // LG 마젠타
};
